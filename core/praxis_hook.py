...
#         not in Syl's ecosystem. Morphogenesis has its own isolated Praxis engine.
#   How:  Surgical removal; 4 grow() tests removed from test_live_ingestion.py.
#         grow() re-implemented in morphogenesis/praxis.py PraxisEngine.
